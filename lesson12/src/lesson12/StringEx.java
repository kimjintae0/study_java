...
public class StringEx {
	public static void main(String[] args) {
		...
		// cd1234ab
//		System.out.println(str.substring(2,10));  > 이런식으로 하면 안됨
		...
		System.out.println("=======================");		
		for (int i = 0; i < fileNames.length; i++) {
			if(fileNames[i].endsWith("abcd")) {
				System.out.println(fileNames[i]);
			}
		}
		File dir = new File("C:\\Users\\TJ\\workspace_java_kjt");
		...
		// 문자열 > 문자열 배열
		String[] strs = "123, 456, 789".split(","); // [ "12", ",456,798" ]
